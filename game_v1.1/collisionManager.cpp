...
CollisionManager* CollisionManager::collisionInstance = NULL;

void CollisionManager::checkPlayer_EnemyBulletCollision(Player* pPlayer)
{
...
void CollisionManager::checkEnemy_PlayerBulletCollision(const std::vector<GameObject*>& objects)
{
...
void CollisionManager::checkPlayer_EnemyCollision(Player* pPlayer, const std::vector<GameObject*>& objects)
{
    SDL_Rect* pRect1 = new SDL_Rect();
    pRect1->x = pPlayer->getPosition().getX();
    pRect1->y = pPlayer->getPosition().getY();
...
void CollisionManager::checkPlayer_TileCollision(Player* pPlayer, const std::vector<TileLayer*>& collisionLayers)
{
