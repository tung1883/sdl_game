...
bool PlayState::onEnter() {
    ...
    //
	////Tilemap textures
	//if (!TheTextureManager::Instance()->loadTexture("res/Tile/blocks1.png", "blocks1", TheGame::Instance()->getRenderer())) {
	//	return false;
	//};
    //
    ...
    onExit();
    TheGame::Instance()->getStateMachine()->pushState(new Level1());
	return true;
}
...
bool PlayState::onExit() {
	...
	std::cout << "Moving to level 1" << std::endl;
	return true;
}

////Checking collision
//void PlayState::checkPlayer_EnemyBulletCollision(Player* pPlayer)
//{
...
//    delete pRect1;
//}
//void PlayState::checkEnemy_PlayerBulletCollision(const std::vector<GameObject*>& objects)
//{
// 
...
//    }
//}
//void PlayState::checkPlayer_EnemyCollision(Player* pPlayer, const std::vector<GameObject*>& objects)
//{
//    if (pPlayer->getWinningDrawing()) {
//        return;
//    }
...
//    delete pRect1;
//}
//void PlayState::checkPlayer_TileCollision(Player* pPlayer, const std::vector<TileLayer*>& collisionLayers)
//{  
//    if (pPlayer->getWinningDrawing()) {
//        return;
//    }
...
//    }
//}
//void PlayState::checkBullet_TileCollision(const std::vector<TileLayer*>& collisionLayers) {
//    for (std::vector<TileLayer*>::const_iterator it = collisionLayers.begin(); it != collisionLayers.end(); it++)
//    {
//        TileLayer* pTileLayer = (*it);
//        std::vector<std::vector<int>> tiles = pTileLayer->getTileMap();
