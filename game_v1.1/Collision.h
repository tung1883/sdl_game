...
{
    int aHBuf = A->h / s_buffer; //Height Buffer for A
    int aWBuf = A->w / s_buffer; //Width Buffer for A

    int bHBuf = B->h / s_buffer; //Height Buffer for B
    int bWBuf = B->w / s_buffer; //Width Buffer for A
